...
const getAllRole = require('../../application/use_cases/auth/role/list');
const createRole = require('../../application/use_cases/auth/role/create');
const getRoleById = require('../../application/use_cases/auth/role/get_by_id');
const deleteRole = require('../../application/use_cases/auth/role/delete');
const updateRole = require('../../application/use_cases/auth/role/update');
