...
module.exports = {
  ...
  async create(request) {
    ...
    const errorMessages = {
      432: 'The client id not found',
      433: 'The employed id not found',
      434: 'The site id not found'
    };
    if (bill in errorMessages) {
      return new Boom.Boom(errorMessages[bill], { statusCode: bill });
    }
