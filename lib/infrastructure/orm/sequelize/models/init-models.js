...
function initModels(sequelize) {
  ...
  auth_user.belongsTo(master_document_type, { as: "document_type", foreignKey: "document_type_id"});
  master_document_type.hasMany(auth_user, { as: "auth_users", foreignKey: "document_type_id"});
  ...
  auth_user.hasMany(mix_bill, { as: "employed_mix_bills", foreignKey: "employed_id"});
  mix_bill_product.belongsTo(mix_bill, { as: "bill", foreignKey: "bill_id"});
  mix_bill.hasMany(mix_bill_product, { as: "mix_bill_products", foreignKey: "bill_id"});
  mix_product.belongsTo(mix_category, { as: "category", foreignKey: "category_id"});
  mix_category.hasMany(mix_product, { as: "mix_products", foreignKey: "category_id"});
  mix_bill.belongsTo(mix_product, { as: "product", foreignKey: "product_id"});
  mix_product.hasMany(mix_bill, { as: "mix_bills", foreignKey: "product_id"});
  mix_bill_product.belongsTo(mix_product, { as: "product", foreignKey: "product_id"});
  mix_product.hasMany(mix_bill_product, { as: "mix_bill_products", foreignKey: "product_id"});
  mix_inventory.belongsTo(mix_product, { as: "product", foreignKey: "product_id"});
  mix_product.hasMany(mix_inventory, { as: "mix_inventories", foreignKey: "product_id"});
  ...
  mix_site.hasMany(mix_inventory, { as: "mix_inventories", foreignKey: "site_id"});
