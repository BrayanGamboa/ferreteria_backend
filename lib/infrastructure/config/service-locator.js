...
function buildBeans() {
  ...
  if (environment.database.dialect === constants.SUPPORTED_DATABASE.IN_MEMORY) {
    ...
    const MixInventoryPostgres = require('../repositories/mix_inventory_repository_postgres');
    const MixBillPostgres = require('../repositories/mix_bill_repository_postgres');
    const MixBillProductPostgres = require('../repositories/mix_bill_product_repository_postgres');
    ...
    beans.mixInventoryRepository = new MixInventoryPostgres();
    beans.mixBillRepository = new MixBillPostgres();
    beans.mixBillProductRepository = new MixBillProductPostgres();
