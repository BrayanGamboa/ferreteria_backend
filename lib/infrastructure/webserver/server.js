...
const createServer = async () => {
  ...
  await server.register([
    ...
    require('../../interfaces/routes/mix_product'),
    require('../../interfaces/routes/mix_inventory'),
    require('../../interfaces/routes/mix_bill'),
    require('../../interfaces/routes/mix_bill_product')
  ]);
